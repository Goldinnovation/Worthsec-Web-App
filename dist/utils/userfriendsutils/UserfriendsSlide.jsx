...
const UserfriendsSlide = () => {
    ...
    return (<div className={styles["friendsSlideLayer"]}>
        <div className={styles["friendsSlideSection"]}>
            <div className={styles["friendsSlideSection_left"]}>
                ...
                {/* </div> */}
                <div>
                    {inputSectionToggle && (<div className={styles["friendsSlidepopLayer"]}>
                            <div>
                            <input type="text" className={styles["friendsSlideSection_Input"]} onChange={handleInput}/>         
                             ...
                             <div className={styles["friendsSlideDisplaySection"]}>
                                {userImgUrl && (<div className={styles["userImgUrllayer"]} onClick={userMessageToggle}>
                                ...
                                <div className={styles["userdoesnotexistLayer"]}>
                                    {userExitPopup && (<div className={styles["userdoesnotexistContent"]}> user does not exist</div>)}
            ...
            <div>
                    {messageToggle && (<div className={styles["messageToggleLaver"]}>
