...
const InviteUsertoEvent = ({ eventIdData }) => {
    ...
    return (<div className="invitelayer">
      <div>
        ...
        <div className="userInviteSearch">
          ...
          <div className="seach_closeFirends_input">
            {searchToggel && (<div className="userInviteSearchArea">
      ...
      <div className="closefriends_Section">
        ...
        {currentUserCloseFriends?.map((event, i) => (<div key={i} className="closeFriendsInviteSection">
            <div className="closefriends_Item" onClick={() => handleSelectFriends(event)}>
              <div className="closefriends_Content">
                <Image src={`/${event.picture.pictureUrl}`} className="inviteCloseFriends_ProfilImg" width={55} height={55} alt="inviteCloseFriends_ProfilImg" priority={true}/>
                {/* Represents the friends which are marked  */}
                {invitedfriendsList.includes(event.userId) && (<div className="closefriends_markItem">
        ...
        {/* represents the successful Invitation Pop Up Text */}
         {checkInvitationStatus && (<div className="invitationPopup_successfulPopUp">
