...
const Createbtn = () => {
    ...
    return (<div>
      {model && (<div className='create_event_overlay'>
          ...
          <div className="create-event-area">
            ...
            <div className='create-event-content'>
              ...
              <input type="range" id="rangeInput" className="selectedRangeofEvents" onChange={handleRangeInput} min="9" max="1000" value={rangeValue}/>
              <output htmlFor="rangeInput" id="outputValue">
                ...
                <div className='invite-content' required>
                  ...
                  <input type="checkbox" id="friendsId" className='Only_friends' onChange={handleInput}/>
                  </div>
               
                  
                  <div className='friendsPlus-content'>
                  <label for="friendsPlusPlus" style={{ color: '#ffffff' }}>Friends++</label>
                  <input type="checkbox" id='friendsPlusPlus' className='friends_Plus_Plus' onChange={handleInput}/>

                  </div>
                 
                  <div className='worldWide-content'>
                  <label for="worldwide" onChange={handleInput} style={{ color: '#ffffff' }}>WorldWide</label>
                  <input type="checkbox" id='worldwide' className='worldwideClass' onChange={handleInput}/>
                  </div>
           ...
           {imagePreview ? (<div className='imageCoverLayer'>
                <Image src={imagePreview} alt="Uploaded Preview" width={260} height={250} className='imagePreview' onClick={() => document.getElementById("UploadtriggerId").click()} style={{ cursor: 'pointer' }} required/>
                </div>) : (<Image src={uploadCoverImg} className='ImageCoverIcon' alt='default Upload ImageIcon' width={100} height={100} onClick={() => document.getElementById("UploadtriggerId").click()} style={{ cursor: 'pointer' }}/>)}
