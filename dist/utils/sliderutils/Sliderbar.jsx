...
const Sliderbar = () => {
    ...
    {messageArea && (<div className={styles['messagePopUpContentArea']}>
            hallo
        </div>)}
    </div>

    <div className={styles['reqFriendPopUpSection']}>
    {reqfriendArea && (<div className={styles['reqFriendPopUpContentArea']}>
            hall2
        </div>)}
    </div>

 <div className={styles['SharePopupArea']}>
        {addShareArea && (<div className={styles['sharePop']}>
    ...
    {viewArea && (<div className={styles['ViewPopup']}>
