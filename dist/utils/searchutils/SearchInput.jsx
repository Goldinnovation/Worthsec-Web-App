...
const SearchInput = () => {
    ...
    return (<div>
      ...
      <div className={searchstyle['searchContent']}>
        <input type="text" className={searchstyle['searchInput']} onChange={(e) => setSearchQuery(e.target.value)}/>
      ...
      <div className={searchstyle['DisplayUserSection']}>
        {displayUserInfo.map((event, i) => (<div key={i}>
              <div className={searchstyle['displayUserArea']}>

                {userProfilImage && (<div className={searchstyle['displayUserContent']}>
                    <div className={searchstyle['DisplayImageArea']}>

                      <Image className={searchstyle['DisplayImageContent']} src={`/${userProfilImage.pictureUrl}`} alt="other user profil picture" width={110} height={70} quality={100}/>
                      ...
                      <div className={searchstyle['userOverlay']}>
                        ...
                        <div className={searchstyle['userOverlayImageContent']}>
                          <Image className={searchstyle['userOverlayImage']} src={`/${userProfilImage.pictureUrl}`} alt='other user Overlay Background Image' width={140} height={140} quality={100}/>
                        </div>
                      </div>
                    </div>
