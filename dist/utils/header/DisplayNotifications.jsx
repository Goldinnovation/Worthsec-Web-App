...
const DisplayNotifications = () => {
    ...
    return (<div>
      ...
      {displayNotification && displayNotification.map ? (displayNotification.map((event, i) => (<div key={i}>


                <div className={style['notificationSection']}>
                <div>
                  {displayNotification.userName}
                    <Image src={`/${event.picture.pictureUrl}`} width={60} height={60} className={style["otherUserImg"]}/>
                </div>
