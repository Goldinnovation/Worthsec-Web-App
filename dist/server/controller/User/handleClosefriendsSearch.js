...
export async function searchforClosefriends(req, res) {
    try {
...
const handlegetConnectionState = async (getFriendDetails, currentUserId, req, res) => {
    try {
 ...
 */
export async function searchImgUrl(req, res) {
    try {
