...
const UserMenu = ({ handProfileToggle, handleExploreToggle, handleExpandUserOptions }) => {
    return (<div className="flex flex-row  w-full ">
           ...
           <div className="cursor-pointer" onClick={handProfileToggle}>
           ...
           <div className="cursor-pointer" onClick={handleExploreToggle}> 
            <Image src={ExploreIcon} width={30} height={30} alt='Explor Icon'/>
           </div>

           <div className="cursor-pointer" onClick={handleExpandUserOptions}>
