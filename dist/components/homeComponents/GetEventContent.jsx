...
const GetEventContent = () => {
    ...
    const handleDelete = async (eventId, eventpath, event) => {
        try {
            const userDeletsEvent = await deleteobj(eventId, eventpath);
            if (eventId && eventpath) {
                const updatedEventContent = allEventContent?.filter((event) => event.eventId !== eventId);
     ...
     {/* after entering all necessary information to create an Event, A object will be generated as the event
       ...
       <div className='contentCreateSection'>
            <div className='eventContentSection'>
                    {allEventContent?.map((event, i) => (<div key={i} className='eventContentSectionArea'>
        ...
        // fill
        width={180} height={170} quality={100} priority={true} alt='Cover of Job ad'/>
       ...
       {selectedEvent && selectedEvent.eventId && (
        ...
        <div className='eventWindowSection'>
                                    ...
                                    <div className='eventUserInfo'>
                                        ...
                                        {eventInfo && (<div className='eventWindowLayer'>
                                         <div className='eventWindowImage'>
                                        <Image src={selectedEvent.ImageCoverUpload} className='eventWindowImageContent' width={440} height={400} quality={100} alt='Cover of Job ad'/>
                                        </div>
                                  ...
                                  {userInviteSection && (<div className='eventInviteUserSection'>
                                                    <div className='eventInvitationLayer'>
                                                            <InviteUsertoEvent eventIdData={selectedEvent.eventId}/>
                                                    </div>
                                  ...
                                  <div className='eventWindowNav'>
                                         ...
                                         <div className='eventWindowNavOptions'>
                                            ...
                                            <Image src={eyeIcon} width={18} height={18} alt='Eye Icon'/>
                                                ...
                                                {eventOptions && (<div className='eventOptionContentArea'>
