...
const Usercontent = () => {
    ...
    return (<div className='min-h-full flex-1 '>
        ...
        {/* <create/> */}
        <header className="flex  h-[4vh] md:h-[5vh] bg-black lg:h-[5vh] bg-opacity-50 xl:h-[6vh] border-b border-gray-300  items-center">
                    ...
                    <div className=" h-[4vh] w-full flex justify-between  ">
                        ...
                        <div className="flex  items-center  justify-end gap-7 pl-1   md:w-1/6 ">
                            <div className={styles['inputSearchArea']}>
                                {searchArea && (<div className={styles['inputSearchOption']}>
                                        <SearchInput />
                        ...
                        <Image src={searchIcon} alt="searchIcon" className="search-Icon" height={18} width={18} onClick={handleToggleSearch}/>
                        ...
                        {notifcation && (<div className={styles['notificationOptionSection']}>
                        ...
                        {connectUserToggle && (<div className={styles['notification_display_connectedUser']}>  
                                <DisplayNotifications />
                                </div>)}
                        {eventInvitesToggle && (<div className={styles['notification_display_eventInvite']}> trap</div>)}
                        
                       
                        {optionToggle && (<div className={styles['userOptionLayer']}>
        ...
        <div className='flex  h-[95vh] w-full'>
            {/*  Left */}
            {expandUserOption && (<div className='w-[3%] bg-black flex flex-col border-r  bg-opacity-50 border-gray-300 '>

                 <div className='h-[80vh]  w-full '>
                 <LeftnavBarContent handleExploreToggle={handleExploreToggle} handProfileToggle={handProfileToggle}/>
                 </div>
                 <div>
                     sd
                 </div>
            ...
            {expandUserOption && (<div className='w-[3%]  bg-black border-l bg-opacity-50'>3</div>)}
            

            {/* User Menu */}
            <div className='userInfoLayer'>
                <UserMenu handleExploreToggle={handleExploreToggle} handProfileToggle={handProfileToggle} handleExpandUserOptions={handleExpandUserOptions}/>
